...
for i in $EXAMPLES; do
  ...
  # ml-ko 디렉토리로 복사
  rm -rf ~/github/adsidelab/ml-ko/html/tfjs/${EXAMPLE_NAME}
  mkdir ~/github/adsidelab/ml-ko/html/tfjs/${EXAMPLE_NAME}
  cp -f ./* ~/github/adsidelab/ml-ko/html/tfjs/${EXAMPLE_NAME}
